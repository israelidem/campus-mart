...
export const AuditAction = {
  ...
  DELIVERY_POOLED: "DELIVERY_POOLED",
  DELIVERY_ACCEPTED: "DELIVERY_ACCEPTED",
  DELIVERY_PICKED_UP: "DELIVERY_PICKED_UP",
  DELIVERY_ARRIVED: "DELIVERY_ARRIVED",
  DELIVERY_PICKUP_EXPIRED: "DELIVERY_PICKUP_EXPIRED",
  DELIVERY_AGENT_CANCELLED: "DELIVERY_AGENT_CANCELLED",
  DELIVERY_RETURNED: "DELIVERY_RETURNED",
  DELIVERY_OTP_ISSUED: "DELIVERY_OTP_ISSUED",
  DELIVERY_OTP_FAILED: "DELIVERY_OTP_FAILED",
  DELIVERY_OTP_VERIFIED: "DELIVERY_OTP_VERIFIED",
  DELIVERY_PAYMENT_TIMED_OUT: "DELIVERY_PAYMENT_TIMED_OUT",
  ...
  RATING_AGGREGATE_RECOMPUTED: "RATING_AGGREGATE_RECOMPUTED",

  DISPUTE_FILED: "DISPUTE_FILED",
  DISPUTE_WITHDRAWN: "DISPUTE_WITHDRAWN",
  DISPUTE_REVIEW_STARTED: "DISPUTE_REVIEW_STARTED",
  DISPUTE_RESOLVED: "DISPUTE_RESOLVED",
  /** Distinct from REFUND_INITIATED: this one names the human who decided. */
